...
<body>
	...
	<div align="center">
	<h1>ALL Lecturer's Availability</h1>
	...
	<table border="1" id="users">
		...
		<tr>
			...
			<td><b>Conducted Platform</b></td>
			<td><b>Available Days</b></td>
			<td><b>Time Session</b></td>
...
%>
		...
		<tr>
			<td><b><%=resultSet.getString("empId") %></b></td>
...
%>
			...
			<br><br>
	 		<a href="TDashboard.jsp" class="previous">&laquo; Lecturer Dashboard</a>
	 		<br><br>
